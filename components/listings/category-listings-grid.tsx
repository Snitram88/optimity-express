...
import { VendorQuickViewModal } from "@/components/modals/vendor-quick-view-modal";

type CategoryListingsGridProps = {
...
export function CategoryListingsGrid({
  listings,
}: CategoryListingsGridProps) {
  const [selectedListing, setSelectedListing] =
    useState<CategoryListingItem | null>(null);
            ...
            <div className="mt-5">
              ...
              <div className="mt-5 flex gap-3">
                ...
                <Link
                  ...
                  className="flex-1 rounded-xl border border-slate-300 bg-white px-4 py-2 text-center text-sm font-medium text-slate-800 transition hover:bg-slate-50"
                >
                  View Vendor
                </Link>
              </div>
